...
from SKL.RelationHandler import RelationHandler
from copy import copy
import time
...
class TIRP:
    ...
    def print_tirp(self,num_relations):
        """
...
def compute_relationship(interval1: Tuple[int, int], interval2: Tuple[int, int], epsilon: int, max_gap: int, num_relations: int) -> int:
    """
